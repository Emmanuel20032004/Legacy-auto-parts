...
const initialUsers = [
  ...
  { id: 4, name: "Viodundo Admin", phone: "+254 734 905 118", email: "viodundo.admin@legacyauto.test", role: "Admin" },
...
export function AdminSidebar() {
  ...
  const [newUser, setNewUser] = useState({ name: "", phone: "", email: "", role: "Customer" });
